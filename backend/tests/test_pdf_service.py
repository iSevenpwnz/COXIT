...
class TestPDFService:
    ...
    def test_calculate_file_hash(self):
        ...
        expected_hash = "1eebdf4fdc9fc7bf283031b93f9aef3338de9052f584eb64f5be2150e0b36fe6"
    ...
    def test_validate_upload_invalid_content_type(self):
        ...
        with pytest.raises(InvalidFileTypeError, match="Only PDF files are supported"):
    ...
    def test_validate_upload_too_many_pages(self, mock_reader):
        ...
        with pytest.raises(PageLimitExceededError, match="PDF has too many pages"):
    ...
    def test_parse_pdf(self, mock_extract_text, mock_count_images, mock_count_tables):
